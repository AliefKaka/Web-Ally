...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Gas Terus! Karena Harta Karun Nggak Nunggu!
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             ABSOLUTE adalah komunitas game One Piece Bounty Rush (OPBR) yang didirikan pada 9 September 2024. Kami mengutamakan kerja sama tim, kompetisi sehat, dan semangat kekeluargaan. Bergabunglah dalam petualangan seru bersama kami!
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Kalau kamu punya semangat dan mau maju bareng kru, ABSOLUTE itu tempatnya"
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://s6.imgcdn.dev/YsiHw9.png" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
              ...
              >
                <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> Download Logo
              </button>
              </a>
              ...
              >
                <Code className="w-4 h-4 sm:w-5 sm:h-5" /> View Dokumentasi
              </button>
              </a>
            </div>
          </div>
