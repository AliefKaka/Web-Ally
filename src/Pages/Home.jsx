...
const WORDS = ["Absolute Alliance", "One Piece Bounty Rush"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/AliefKaka" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ekizr/" },
  { icon: Instagram, link: "https://www.instagram.com/m.alif666/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  ABSOLUTE adalah rumah para bajak laut sejati—tempat tawa, strategi, dan perburuan harta jadi satu petualangan seru!
                </p>
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  <CTAButton href="#Portofolio" text="Dokumentasi" icon={ExternalLink} />
                  <CTAButton href="#Contact" text="Daftar" icon={Mail} />
                </div>
